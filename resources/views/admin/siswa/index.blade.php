...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Data Siswa Siswa - E-Learning SMP Negeri 1 Turi Lamongan</title>
				...
				<ul id="accordion-menu">
					<li>
						<a href="calendar.html" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext">Beranda</span>
						</a>
					</li>
					<li>
						<a href="datasiswa.html" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext">Data Siswa</span>
						</a>
					</li>
					<li>
						<a href="dataguru.html" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext">Data Guru</span>
						</a>
					</li>
					<li>
					...
					<li>
						<a href="manajemenkelas.html" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext">Manajaemen Kelas</span>
						</a>
					</li>
					<li>
						<a href="manajemenmatapelajaran.html" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext">Manajemen Mata Pelajaran</span>
						</a>
					</li>
					<li>
					...
					<li>
						<a href="logout.html" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext">Keluar</span>
						</a>
					</li>
				</ul>
			</div>
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">DataSiswa</li>
								</ol>
							</nav>
						</div>
					</div>
