...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Jadwal Mata Pelajaran - Bootstrap Admin Dashboard HTML Template</title>
			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						...
						<span class="user-name">Kasri</span>
					</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					<li>
						<a href="guru.html" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-home"></span><span class="mtext">Beranda</span>
						</a>
					</li>
					<li>
						<a href="pengumumanguru.html" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext">Pengumuman</span>
						</a>
					</li>
					<li>
						<a href="jadwalguru.html" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar"></span><span class="mtext">Jadwal</span>
						</a>
					</li>
					<li>
						<a href="tugasguru.html" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-agenda"></span><span class="mtext">Tugas</span>
						</a>
					</li>
					<li>
						<a href="materiguru.html" class="dropdown-toggle no-arrow">
				...
				<div class="row">
					<div class="col-lg-4 col-md-6 col-sm-12 mb-30">
						<div class="pd-20 card-box height-100-p">
							...
							<ul class="list-group">
								<li class="list-group-item">Bahasa Indonesia <button type="button" class="btn btn-info">Edit</button></li>
