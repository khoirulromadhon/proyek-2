...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Guru - E-Learning Smp Negeri 1 Turi Lamongan</title>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li>
						<a href="pengumuman.html" class="dropdown-toggle no-arrow">
				...
				<div class="row align-items-center">
					...
					<div class="col-md-8">
						<h4 class="font-20 weight-500 mb-10 text-capitalize">
							Selamat Datang<div class="weight-600 font-30 text-blue">Guru</div>
						</h4>
