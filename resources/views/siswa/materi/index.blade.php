...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Materi - E-Learning SMP Negeri 1 Turi Lamongan</title>

	<!-- Site favicon -->
	<link rel="apple-touch-icon" sizes="180x180" href="{{ asset('/vendors/images/') }}">
	<link rel="icon" type="image/png" sizes="32x32" href="{{ asset('/vendors/images/') }}">
	<link rel="icon" type="image/png" sizes="16x16" href="{{ asset('/vendors/images/') }}">
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li>
						<a href="tugassiswa.html" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-agenda"></span><span class="mtext">Tugas</span>
						</a>
					</li>
					<li>
						<a href="materisiswa.html" class="dropdown-toggle no-arrow">
						...
						<ul class="row">
							<li class="col-lg-4 col-md-6 col-sm-12">
								<div class="product-box">
									<div class="producct-img"><img src="vendors/images/" alt=""></div>
									<div class="product-caption">
										<h4><a href="#">Bahasa Indonesia</a></h4>
										<div class="price">
											<p>Kelas VII</p>
										</div>
										<a href="detailmateri.html" class="btn btn-outline-primary">Lihat Selengkapnya</a>
									</div>
								</div>
							</li>
							<li class="col-lg-4 col-md-6 col-sm-12">
							...
							<li class="col-lg-4 col-md-6 col-sm-12">
								<div class="product-box">
									<div class="producct-img"><img src="vendors/images/" alt=""></div>
									<div class="product-caption">
										<h4><a href="#">Ilmu Pengetahuan Alam</a></h4>
										<div class="price">
											<p>Kelas VII</p>
										</div>
										<a href="#" class="btn btn-outline-primary">Lihat Selengkapnya</a>
